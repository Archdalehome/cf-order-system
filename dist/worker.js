...
`;function de(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function we(t){let e=String(t||"").trim();if(!e)return"";let a=de(e);return`<link rel="icon" href="${a}">
...
${r?`    <div class="hint hint-inline">忘记密码请联系 <span class="support-mail">${de(r)}</span></div>
