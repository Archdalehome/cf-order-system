...
`;function oe(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function ge(t){let e=String(t||"").trim();if(!e)return"";let a=oe(e);return`<link rel="icon" href="${a}">
...
`}var ze=`
  ...
  </div>`;function ve(t,e,a,d){let m=t||"待办清单",p=e!==!1,r=String(a??"").trim();return`<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
...
${r?`    <div class="hint hint-inline">忘记密码请联系 <span class="support-mail">${oe(r)}</span></div>
...
</html>`}function ke(t){return`<!DOCTYPE html>
<html lang="zh-CN">
<head>
<meta charset="UTF-8">
<meta name="viewport" content="width=device-width, initial-scale=1.0">
...
</html>`}import{connect as Ve}from"cloudflare:sockets";var J="default",Ke="__platform__",je=24*60*60*1e3,Je="该功能为专业版功能：请点击顶栏「订阅」升级为专业用户后使用（试用账号仅限本人使用与添加订单）",R=/^[A-Za-z0-9._%+-]+@[A-Za-z0-9-]+(\.[A-Za-z0-9-]+)*\.[A-Za-z]{2,}$/,z=10*60,Te=5,de=60,qe=5,Qe=1e4,H=3,He=2e4,Fe=8e3;function D(){let t=new Uint8Array(24);return crypto.getRandomValues(t),Array.from(t,e=>e.toString(16).padStart(2,"0")).join("")}async function M(t){let e=new TextEncoder().encode(t+"::cf-todolist-salt"),a=await crypto.subtle.digest("SHA-256",e);return Array.from(new Uint8Array(a),d=>d.toString(16).padStart(2,"0")).join("")}function K(t){let e=String(t??"").trim();return e?!/^https?:\/\//i.test(e)||/\s/.test(e)?null:e:""}var We=["USD","CNY"];function Ge(t){let e=String(t??"").trim().toUpperCase();return We.includes(e)?e:"USD"}function n(t,e=200){return new Response(JSON.stringify(t),{status:e,headers:{"Content-Type":"application/json; charset=utf-8"}})}async function S(t){try{return await t.json()}catch{return{}}}function Me(t){let a=(t.headers.get("Cookie")||"").match(/(?:^|;\s*)token=([^;]+)/);return a?a[1]:null}function h(t){return t?O(t.role)?Ke:t.teamId||J:J}function O(t){return t==="superadmin"}function T(t){return t==="team"}function ne(t){return!!t&&(t.plan==="pro"||t.plan==="paid")}function re(t){if(!t)return"active";if(t.status==="disabled")return"disabled";if(ne(t)){let e=t.expiresAt||"";if(e&&new Date(e).getTime()<Date.now())return"expired"}return"active"}function P(t){return ne(t)&&re(t)==="active"}function Ae(t){return t&&(t.subscribeRequest||t.renewRequest)||null}function N(){return n({error:Je},403)}async function U(t,e){if(!e||e===J)return null;let a=await t.TODO_KV.get(`user:${e}`);if(!a)return null;let d=JSON.parse(a);return T(d.role)?d:null}async function Ye(t,e){return e?T(e.role)?P(e):P(await U(t,h(e))):!1}async function w(t,e){let a=Me(t);if(!a)return null;let d=await e.TODO_KV.get(`session:${a}`);if(!d)return null;let m=await e.TODO_KV.get(`user:${d}`);if(!m)return null;let p=JSON.parse(m);if(!O(p.role)){let r=await U(e,h(p));if(r&&r.status==="disabled")return null}return p}function Ze(){let t=new Uint32Array(1);return crypto.getRandomValues(t),String(t[0]%1e6).padStart(6,"0")}function _(t){return String(t??"").replace(/[&<>"']/g,e=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[e])}function W(t){let e=String(t||"").trim(),a=e.lastIndexOf("@");if(a<=0)return e;let d=e.slice(0,a),m=d.slice(0,Math.min(2,d.length));return m+"*".repeat(Math.max(1,d.length-m.length))+e.slice(a)}function ue(t){try{let e=new URL(t.url).hostname;return e==="localhost"||e==="127.0.0.1"||e==="::1"||e==="[::1]"}catch{return!1}}function Xe(t){let e=new Date(t||Date.now());if(Number.isNaN(e.getTime()))return String(t||"");let a=new Date(e.getTime()+8*60*60*1e3),d=m=>String(m).padStart(2,"0");return`${a.getUTCFullYear()}-${d(a.getUTCMonth()+1)}-${d(a.getUTCDate())} ${d(a.getUTCHours())}:${d(a.getUTCMinutes())}`}function pe(t){let e=Array.isArray(t)?t.slice(0,H):[],a=[];for(let d=0;d<H;d++){let m=String(e[d]||"").trim();a.push(m&&m.length<=300&&!/\s/.test(m)&&/^https?:\/\//i.test(m)?m:"")}return a}function F(t){let e=String(t&&t.to||"").trim().toLowerCase(),a=t&&t.cc!==void 0&&t.cc!==null?t.cc:[],d=Array.isArray(a)?a:[a],m=[];for(let p of d){let r=String(p||"").trim();!r||!R.test(r)||r.toLowerCase()!==e&&(m.some(o=>o.toLowerCase()===r.toLowerCase())||m.push(r))}return m}function et(t,e){let a=[t&&t.adminNotifyEmail,t&&t.from,e&&e.supportEmail];for(let d of a){let m=String(d||"").trim();if(m&&R.test(m))return m}return""}async function ee(t){let e={};try{let b=await t.TODO_KV.get("emailSettings");b&&(e=JSON.parse(b)||{})}catch{e={}}let a=String(t.RESEND_API_KEY||e.apiKey||"").trim(),d=String(t.MAIL_FROM_NAME||e.fromName||"").trim(),m=String(t.SMTP_HOST||e.smtpHost||"smtp.qq.com").trim(),p=Number(t.SMTP_PORT||e.smtpPort||465)||465,r=String(t.SMTP_USER||t.QQ_MAIL_USER||e.smtpUser||"").trim(),o=String(t.SMTP_PASS||t.QQ_MAIL_PASS||e.smtpPass||"").trim(),s=String(t.MAIL_FROM||e.from||"").trim(),i=t.SEND_EMAIL&&typeof t.SEND_EMAIL.send=="function"?t.SEND_EMAIL:null,l=s||(r&&R.test(r)?r:""),c=a?"resend":r&&o?"smtp":i?"cloudflare":"",u=String(t.ADMIN_NOTIFY_EMAIL||e.adminNotifyEmail||"").trim(),f=pe(e.subQrCodes),g=a?t.RESEND_API_KEY?"env":"kv":r&&o?t.SMTP_USER||t.SMTP_PASS||t.QQ_MAIL_USER||t.QQ_MAIL_PASS?"env":"kv":i?"binding":"none";return{provider:c,apiKey:a,from:l,fromName:d,smtpHost:m,smtpPort:p,smtpUser:r,smtpPass:o,binding:i,adminNotifyEmail:u,subExtraText:String(e.subExtraText||"").trim(),subQrCodes:f,devMode:e.devMode===!0,source:g}}function ae(t){let e=new TextEncoder().encode(String(t??"")),a="";for(let d=0;d<e.length;d++)a+=String.fromCharCode(e[d]);return btoa(a)}function Se(t){let e=String(t||""),a=[];for(let d=0;d<e.length;d+=76)a.push(e.slice(d,d+76));return a.join(`\r
`)}function Ie(t){let e=String(t??"");return/^[\x20-\x7e]*$/.test(e)?e:`=?UTF-8?B?${ae(e)}?=`}var tt="support@cloudnexus.cn";async function j(t){let e={};try{let a=await t.TODO_KV.get("settings");a&&(e=JSON.parse(a)||{})}catch{e={}}return{siteName:e.siteName||"待办清单",allowRegister:e.allowRegister!==!1,supportEmail:e.supportEmail===void 0?tt:String(e.supportEmail||"").trim(),favicon:String(e.favicon||"").trim()}}function Ce(t){let e=String(t||"");return e?e.slice(0,4)+"****"+e.slice(-4):""}function Pe(t,e){return{provider:t.provider,source:t.source,from:t.from,fromName:t.fromName,hasApiKey:!!t.apiKey,apiKeyMasked:Ce(t.apiKey),smtpHost:t.smtpHost,smtpPort:t.smtpPort,smtpUser:t.smtpUser,hasSmtpPass:!!t.smtpPass,smtpPassMasked:Ce(t.smtpPass),devMode:t.devMode,adminNotifyEmail:t.adminNotifyEmail||"",subExtraText:t.subExtraText||"",subQrCodes:pe(t.subQrCodes).concat("").slice(0,H),envApiKey:!!e.RESEND_API_KEY,envFrom:!!e.MAIL_FROM,envSmtp:!!(e.SMTP_USER||e.SMTP_PASS||e.QQ_MAIL_USER||e.QQ_MAIL_PASS)}}function rt(t,e){let a="cfmail_"+D().slice(0,16),d=String(t.from||"localhost").split("@")[1]||"localhost",m=t.fromName?`${Ie(t.fromName)} <${t.from}>`:`<${t.from}>`,p=F(e),r=[`From: ${m}`,`To: <${e.to}>`];return p.length&&r.push(`Cc: ${p.map(o=>`<${o}>`).join(", ")}`),r.push(`Subject: ${Ie(e.subject||"")}`,`Date: ${new Date().toUTCString()}`,`Message-ID: <${D()}@${d}>`,"MIME-Version: 1.0",`Content-Type: multipart/alternative; boundary="${a}"`,""),r.concat([`--${a}`,"Content-Type: text/plain; charset=UTF-8","Content-Transfer-Encoding: base64","",Se(ae(e.text||"")),`--${a}`,"Content-Type: text/html; charset=UTF-8","Content-Transfer-Encoding: base64","",Se(ae(e.html||e.text||"")),`--${a}--`,""]).join(`\r
`)}function nt(t,e,a){let d=null;return Promise.race([t,new Promise((m,p)=>{d=setTimeout(()=>{try{a&&a()}catch{}p(new Error(`连接或响应超时（${Math.round(e/1e3)} 秒）`))},e)})]).finally(()=>clearTimeout(d))}function at(t,e,a){let d=t&&t.message?t.message:String(t),m=(d.match(/\b(\d{3})\b/)||[])[1]||"",p="（提示：本地 `wrangler dev` 已支持 SMTP 的 TLS；如持续超时请检查网络 / 端口是否被拦截，或先用「调试模式」联调）",r="";return m==="535"||m==="534"?r="（提示：QQ 邮箱必须使用「SMTP 授权码」而不是 QQ 登录密码，并先在 QQ 邮箱「设置 → 账户」中开启 SMTP 服务）":m==="530"?r="（提示：服务器要求先建立加密连接 —— 465 用 SSL、587 用 STARTTLS）"+(a?p:""):m==="550"||m==="553"?r="（提示：QQ 邮箱要求「发件邮箱」与 SMTP 账号完全一致）":a&&/secureTransport|starttls|tls|ssl|certificate|handshake|超时|关闭/i.test(d)?r=p:/starttls must be set|secureTransport/i.test(d)?r="（提示：587 必须先以 STARTTLS 建立连接再升级；若持续失败请把端口改为 465（SSL）重试）":/certificate|tls|ssl|handshake/i.test(d)?r="（提示：端口 465 使用 SSL，端口 587 使用 STARTTLS，请检查服务器 / 端口设置）":/超时/.test(d)&&(r="（提示：连接超时通常是网络或端口被拦截所致；QQ 邮箱请用 smtp.qq.com 的 465（SSL）或 587（STARTTLS））"),`SMTP 发信失败（${e}）：${d}${r}`}async function ot(t,e,a){let d=Number(t.smtpPort)||465,m=[d];d===465?m.push(587):d===587&&m.push(465);let p=[];for(let r=0;r<m.length;r++){let o=await st(m[r],t,e,a);if(o.ok)return o;p.push(m.length>1?`端口 ${m[r]}：${o.error}`:o.error)}return{ok:!1,error:p.join("；")}}async function st(t,e,a,d){let m=e.smtpHost||"smtp.qq.com",p=!!(d&&d.local),r=Number(e.smtpTimeoutMs)||(p?Fe:He),o=new TextEncoder,s=new TextDecoder,i=null,l=null,c=null,u="",f=`连接 ${m}:${t}`;async function g(){for(;;){let x=u.indexOf(`
`);if(x!==-1){let y=u.slice(0,x);return u=u.slice(x+1),y.replace(/\r$/,"")}let{value:E,done:C}=await l.read();if(C)throw new Error("连接已被服务器关闭");u+=s.decode(E,{stream:!0})}}async function b(){let x=0,E="";for(;;){let C=await g();if(!(C.length<3)&&(x=parseInt(C.slice(0,3),10)||x,E+=(E?" ":"")+C.slice(4).trim(),C.charAt(3)!=="-"))break}return{code:x,text:E}}async function v(x,E){await c.write(o.encode(x+`\r
`));let C=await b();if(!E.includes(C.code))throw new Error(`服务器返回 ${C.code}${C.text?" "+C.text:""}`);return C}async function k(){f=`连接 ${m}:${t}`;try{await i.opened}catch(B){throw new Error(`建立连接失败：${B&&B.message?B.message:B}`)}let x=await b();if(x.code!==220)throw new Error(`服务器返回 ${x.code} ${x.text}`);let C=`EHLO ${e.smtpEhlo||String(e.from||"").split("@")[1]||"localhost"}`;if(await v(C,[250]),t===587){f="STARTTLS",await v("STARTTLS",[220]);try{l.releaseLock()}catch{}try{c.releaseLock()}catch{}i=i.startTls(),u="",l=i.readable.getReader(),c=i.writable.getWriter(),await v(C,[250])}f="身份认证（SMTP 授权码）",await v("AUTH LOGIN",[334]),await v(ae(e.smtpUser),[334]),await v(ae(e.smtpPass),[235]),f="发件地址",await v(`MAIL FROM:<${e.from}>`,[250]);let y=[a.to].concat(F(a));for(let B=0;B<y.length;B++)f=B===0?"收件地址":"抄送地址",await v(`RCPT TO:<${y[B]}>`,[250,251]);f="发送邮件正文",await v("DATA",[354]);let I=rt(e,a).replace(/\r\n\./g,`\r
..`);await c.write(o.encode(`${I}\r
.\r
`));let $=await b();if($.code!==250)throw new Error(`服务器返回 ${$.code}${$.text?" "+$.text:""}`);try{await v("QUIT",[221])}catch{}return{ok:!0,id:""}}try{return i=Ve({hostname:m,port:t},{secureTransport:t===587?"starttls":"on"}),l=i.readable.getReader(),c=i.writable.getWriter(),await nt(k(),r,()=>{try{i.close()}catch{}})}catch(x){return{ok:!1,error:at(x,f,p)}}finally{try{i&&i.close()}catch{}}}async function we(t,e,a,d){if(!e.provider)return{ok:!1,error:"邮件服务未配置：请在控制台「邮件设置」中填写 QQ 邮箱 SMTP 账号与授权码（或 Resend API Key）"};if(!e.from)return{ok:!1,error:"邮件服务缺少「发件邮箱地址」：请在控制台「邮件设置」中补全后重试"};if(e.provider==="smtp")return ot(e,a,d);if(e.provider==="resend"){let m=new AbortController,p=setTimeout(()=>m.abort(),Qe);try{let r=await fetch("https://api.resend.com/emails",{method:"POST",headers:{Authorization:`Bearer ${e.apiKey}`,"Content-Type":"application/json"},body:JSON.stringify(Object.assign({from:e.fromName?`${e.fromName} <${e.from}>`:e.from,to:[a.to],subject:a.subject,text:a.text,html:a.html},F(a).length?{cc:F(a)}:{})),signal:m.signal}),o=await r.json().catch(()=>({}));return r.ok?{ok:!0,id:o.id||""}:{ok:!1,error:`邮件服务返回错误（${r.status}）：${o.message||o.error||"请检查 API Key 与发件域名"}`}}catch(r){return{ok:!1,error:"邮件服务请求失败："+(r&&r.message?r.message:String(r))}}finally{clearTimeout(p)}}try{let m=F(a);return await e.binding.send({from:e.fromName?{name:e.fromName,email:e.from}:e.from,to:m.length?[a.to].concat(m):a.to,subject:a.subject,html:a.html,text:a.text}),{ok:!0,id:""}}catch(m){return{ok:!1,error:"邮件发送失败："+(m&&m.message?m.message:String(m))}}}async function it(t,e,a){let d="待办清单";try{let s=await t.TODO_KV.get("settings");if(s){let i=JSON.parse(s);i&&i.siteName&&(d=i.siteName)}}catch{}let m=e.teamName||e.username,p=`【${d}】邮箱确认码 ${a}（10 分钟内有效）`,r=[`${m}，您好：`,"",`您正在注册「${d}」的团队账号（登录名：${e.username}）。`,`邮箱确认码：${a}`,"有效期：10 分钟。","","请在注册 / 登录页面输入上面的确认码完成验证，验证通过后即可正常登录。","若非本人操作，请忽略本邮件：验证通过前该账号无法登录。","",d].join(`
`),o=`<div style="font-family:-apple-system,'Microsoft YaHei',sans-serif;font-size:14px;color:#37352f;line-height:1.7"><p>${_(m)}，您好：</p><p>您正在注册「${_(d)}」的团队账号（登录名：<b>${_(e.username)}</b>）。</p><p>邮箱确认码：</p><p style="font-size:26px;font-weight:700;letter-spacing:6px;color:#2383e2;margin:8px 0">${a}</p><p>有效期 <b>10 分钟</b>。请在注册 / 登录页面输入该确认码完成验证，验证通过后即可正常登录。</p><p style="color:#9b9a97;font-size:12px">若非本人操作，请忽略本邮件：验证通过前该账号无法登录。</p></div>`;return{subject:p,text:r,html:o}}async function dt(t,e,a,d,m){let p="待办清单";try{let y=await t.TODO_KV.get("settings");if(y){let I=JSON.parse(y);I&&I.siteName&&(p=I.siteName)}}catch{}let o=m==="renew"?"续费申请":"订阅申请",s=e.teamName||e.username,i=a&&a.plan?a.plan:null,l=i?`${i.term}（￥${i.price} / ${i.days} 天）`:"未选择套餐",c=Xe(a&&a.at?a.at:new Date().toISOString()),u=String(d&&d.subExtraText||"").trim(),f=pe(d&&d.subQrCodes).filter(Boolean),g=`【${p}】${o}已收到：${s} · ${l}`,b=[`${s}，您好：`,"",`我们已收到您的「${o}」，信息如下（本邮件已同步抄送管理员）：`,"","【申请人信息】",`团队名称：${s}`,`登录账号：${e.username}`,`联系人：${e.contact||"（未填写）"}`,`联系邮箱：${e.email||"（未填写）"}`,`提交时间：${c}`,"","【订阅套餐】",`申请类型：${o}`,`套餐：${l}`,`留言：${a&&a.note||"（无）"}`,""];u&&b.push("【说明】",u,""),f.length&&(b.push("【收款二维码】"),f.forEach((y,I)=>b.push(`二维码 ${I+1}：${y}`)),b.push("")),b.push("提交后由超级管理员为您开通；开通成功后即可使用成员 / 生产方 / 客户管理等全部功能。","如需补充信息，可在系统内重新提交申请（会覆盖上一次）。","",p);let v=b.join(`
`),k=(y,I)=>`<tr><td style="padding:4px 12px 4px 0;color:#6b6b68;white-space:nowrap">${_(y)}</td><td style="padding:4px 0;color:#37352f">${_(I)}</td></tr>`,x=u?`<div style="margin:14px 0 6px;font-weight:600">说明</div><div style="background:#f7f7f5;border-radius:8px;padding:12px;white-space:pre-wrap">${_(u)}</div>`:"",E=f.length?'<div style="margin:16px 0 6px;font-weight:600">收款二维码</div>'+f.map((y,I)=>`<div style="display:inline-block;margin:0 12px 12px 0;text-align:center;vertical-align:top"><img src="${_(y)}" alt="收款二维码 ${I+1}" style="width:180px;height:180px;object-fit:contain;border:1px solid #e9e9e7;border-radius:8px;background:#fff"><div style="font-size:12px;color:#6b6b68;margin-top:4px">二维码 ${I+1}</div></div>`).join(""):"",C=`<div style="font-family:-apple-system,'Microsoft YaHei',sans-serif;font-size:14px;color:#37352f;line-height:1.7"><p>${_(s)}，您好：</p><p>我们已收到您的「<b>${_(o)}</b>」，信息如下（本邮件已同步抄送管理员）：</p><div style="margin:10px 0 6px;font-weight:600">申请人信息</div><table style="border-collapse:collapse;font-size:14px">`+k("团队名称",s)+k("登录账号",e.username)+k("联系人",e.contact||"（未填写）")+k("联系邮箱",e.email||"（未填写）")+k("提交时间",c)+'</table><div style="margin:14px 0 6px;font-weight:600">订阅套餐</div><table style="border-collapse:collapse;font-size:14px">'+k("申请类型",o)+k("套餐",l)+k("留言",a&&a.note||"（无）")+"</table>"+x+E+'<p style="margin-top:16px;color:#6b6b68;font-size:13px">提交后由超级管理员为您开通；开通成功后即可使用成员 / 生产方 / 客户管理等全部功能。<br>如需补充信息，可在系统内重新提交申请（会覆盖上一次）。</p></div>';return{subject:g,text:v,html:C}}async function xe(t,e,a){let d=await ee(t),m=d.devMode||!d.provider&&ue(a);if(!d.provider&&!m)return{ok:!1,error:"邮件服务未配置：请联系超级管理员在控制台「邮件设置」中配置发件服务后再试"};if(d.provider&&!d.from)return{ok:!1,error:"邮件服务缺少「发件邮箱地址」：请先联系超级管理员补全配置"};if(!e.email)return{ok:!1,error:"该账号没有可用的注册邮箱，请重新注册"};let p=Date.now(),r=`mailrate:${e.username}`,o=null;try{let c=await t.TODO_KV.get(r);o=c?JSON.parse(c):null}catch{o=null}let s=!!(o&&p-Number(o.windowStart||0)<60*60*1e3);if(s){let c=de*1e3-(p-Number(o.lastSentAt||0));if(c>0)return{ok:!1,error:`确认码刚发送过，请 ${Math.ceil(c/1e3)} 秒后再点「重新发送确认码」`};if(Number(o.count||0)>=qe)return{ok:!1,error:"发送过于频繁（1 小时内最多 5 次），请稍后再试"}}let i=Ze();if(m)console.log(`[邮箱确认码] ${e.username} <${e.email}> 确认码：${i}（调试模式，未真实发送邮件）`);else{let c=await it(t,e,i),u=await we(t,d,{to:e.email,...c},{local:ue(a)});if(!u.ok)return{ok:!1,error:u.error}}await t.TODO_KV.put(`emailcode:${e.username}`,JSON.stringify({codeHash:await M(i),email:e.email||"",sentAt:p,attempts:0}),{expirationTtl:z});let l=s?{windowStart:o.windowStart,count:Number(o.count||0)+1,lastSentAt:p}:{windowStart:p,count:1,lastSentAt:p};return await t.TODO_KV.put(r,JSON.stringify(l),{expirationTtl:Math.max(60,Math.ceil((60*60*1e3-(p-Number(l.windowStart)))/1e3))}),{ok:!0,sentAt:p,devCode:m?i:""}}async function ct(t,e,a){try{let m=await t.TODO_KV.get(`emailcode:${e.username}`);if(m){let p=JSON.parse(m);if(z*1e3-(Date.now()-Number(p.sentAt||0))>0)return{ok:!0,resent:!1,sentAt:p.sentAt,devCode:""}}}catch{}let d=await xe(t,e,a);return d.ok?{ok:!0,resent:!0,sentAt:d.sentAt,devCode:d.devCode}:{ok:!1,error:d.error}}async function lt(t,e,a){let d=`emailcode:${e.username}`,m=String(a||"").trim();if(!m)return{ok:!1,error:"请输入邮箱确认码"};let p=await t.TODO_KV.get(d);if(!p)return{ok:!1,error:"确认码已失效，请点击「重新发送确认码」重新获取"};let r=null;try{r=JSON.parse(p)}catch{r=null}if(!r||!r.codeHash)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码已失效，请点击「重新发送确认码」重新获取"};if(Date.now()-Number(r.sentAt||0)>z*1e3)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码已过期（有效期 10 分钟），请点击「重新发送确认码」"};if(Number(r.attempts||0)>=Te)return await t.TODO_KV.delete(d),{ok:!1,error:"确认码错误次数过多，请点击「重新发送确认码」重新获取"};if(await M(m)!==r.codeHash){r.attempts=Number(r.attempts||0)+1;let o=Te-r.attempts;return o<=0?(await t.TODO_KV.delete(d),{ok:!1,error:"确认码错误次数过多，请点击「重新发送确认码」重新获取"}):(await t.TODO_KV.put(d,JSON.stringify(r),{expirationTtl:z}),{ok:!1,error:`确认码不正确，请检查后重试（还可尝试 ${o} 次）`})}return{ok:!0}}async function be(t,e){let a=D();return await t.TODO_KV.put(`session:${a}`,e.username,{expirationTtl:60*60*24*7}),new Response(JSON.stringify({ok:!0,username:e.username,role:e.role}),{status:200,headers:{"Content-Type":"application/json; charset=utf-8","Set-Cookie":`token=${a}; Path=/; HttpOnly; SameSite=Lax; Max-Age=${60*60*24*7}`}})}async function se(t){let e=await t.TODO_KV.get("user:admin");if(!e){let d={username:"admin",password:await M("admin"),role:"superadmin",createdAt:new Date().toISOString()};await t.TODO_KV.put("user:admin",JSON.stringify(d));return}let a=JSON.parse(e);a.role==="admin"&&(a.role="superadmin",await t.TODO_KV.put("user:admin",JSON.stringify(a)))}async function Le(t,e){let a=await t.TODO_KV.list({prefix:"user:"}),d=[];for(let m of a.keys){let p=await t.TODO_KV.get(m.name);if(p){let r=JSON.parse(p);if(r.role==="producer"||r.role==="customer"||O(r.role)||T(r.role)||h(r)!==e)continue;let o={username:r.username,role:r.role,createdAt:r.createdAt,remark:r.remark||"",dept:r.dept||"",canPlaceOrder:le(r)};r.role==="restricted"&&(o.watched=await te(t,r.username)),o.mentionsUnread=await bt(t,r.username),d.push(o)}}return d}async function A(t,e,a){let d=await t.TODO_KV.get(`user:${e}`);if(!d)return null;let m=JSON.parse(d);return O(m.role)||h(m)!==a?null:m}async function ut(t){let e=await t.TODO_KV.list({prefix:"user:"}),a=[];for(let d of e.keys){let m=await t.TODO_KV.get(d.name);if(!m)continue;let p=JSON.parse(m);T(p.role)&&a.push({username:p.username,teamName:p.teamName||p.username,contact:p.contact||"",email:p.email||"",remark:p.remark||"",plan:ne(p)?"pro":"trial",pro:P(p),status:re(p),rawStatus:p.status||"active",emailVerified:p.emailVerified!==!1,emailVerifiedAt:p.emailVerifiedAt||"",trialEndsAt:p.trialEndsAt||"",expiresAt:ne(p)&&p.expiresAt||"",createdAt:p.createdAt,renewedAt:p.renewedAt||"",subscribeRequest:Ae(p)})}return a.sort((d,m)=>{let p=d.subscribeRequest&&d.subscribeRequest.at?1:0,r=m.subscribeRequest&&m.subscribeRequest.at?1:0;return p!==r?r-p:d.createdAt<m.createdAt?1:-1}),a}async function q(t,e){let a=await t.TODO_KV.get(`todos:${e}`);return a?JSON.parse(a):[]}async function G(t,e,a){await t.TODO_KV.put(`todos:${e}`,JSON.stringify(a))}async function Q(t,e){let a=await t.TODO_KV.get(`customers:${e}`);return a?JSON.parse(a):[]}async function he(t,e,a){await t.TODO_KV.put(`customers:${e}`,JSON.stringify(a))}async function V(t,e){let a=!e||e===J?"customerList":`customerList:${e}`,d=await t.TODO_KV.get(a);return d?JSON.parse(d):[]}async function ce(t,e,a){let d=!e||e===J?"customerList":`customerList:${e}`;await t.TODO_KV.put(d,JSON.stringify(a))}async function mt(t,e,a){let d=String(a||"").trim();if(!d)return;let m=await Q(t,e.username);m.some(o=>o.name===d)||(m.push({id:D().slice(0,12),name:d,createdAt:new Date().toISOString()}),await he(t,e.username,m));let p=h(e),r=await V(t,p);r.some(o=>o.name===d)||(r.push({id:D().slice(0,12),name:d,description:"",createdAt:new Date().toISOString()}),await ce(t,p,r))}var Ue=["self","purchased"],pt="self";function De(t){let e=String(t??"").trim();return Ue.includes(e)?e:pt}async function L(t,e){let a=!e||e===J?"producers":`producers:${e}`,d=await t.TODO_KV.get(a);return(d?JSON.parse(d):[]).map(p=>({id:p.id,username:p.username||p.shortName||"",description:p.description||"",nature:De(p.nature),createdAt:p.createdAt}))}async function ie(t,e,a){let d=!e||e===J?"producers":`producers:${e}`;await t.TODO_KV.put(d,JSON.stringify(a))}async function te(t,e){let a=await t.TODO_KV.get(`watch:${e}`);return a?JSON.parse(a):[]}async function Oe(t,e,a){await t.TODO_KV.put(`watch:${e}`,JSON.stringify(a))}var ft=50;function gt(t){let e=new Set,a=/@([A-Za-z0-9_.-]{3,20})/g,d=String(t||""),m;for(;(m=a.exec(d))!==null;)e.add(m[1]);return[...e]}async function Ne(t,e){let a=[],d=await U(t,e);d&&a.push({username:d.username,role:d.role,isTeamAdmin:!0,label:d.teamName||d.username});let m=await Le(t,e);for(let p of m)a.push({username:p.username,role:p.role,dept:p.dept||"",isTeamAdmin:!1,label:p.username});return a}async function me(t,e){let a=await t.TODO_KV.get(`mentions:${e}`);return a?JSON.parse(a):[]}async function $e(t,e,a){await t.TODO_KV.put(`mentions:${e}`,JSON.stringify(a.slice(0,ft)))}async function Re(t,e){let a=await me(t,e);return{unread:a.filter(d=>!d.read).length,total:a.length}}async function bt(t,e){return(await Re(t,e)).unread}async function yt(t,e,a,d){if(!a||!a.length)return;let m=new Date().toISOString();for(let p of a){let r=await me(t,p);r.unshift({id:D().slice(0,12),from:e.username,todoId:d.todoId,todoTitle:d.todoTitle||"",todoOwner:d.owner||"",text:d.text||"",at:m,read:!1}),await $e(t,p,r)}}var wt=["生产部","计划部","采购部","品质部","财务部"],xt="生产部";function ht(t,e){if(e!=="restricted")return"";let a=String(t??"").trim();return wt.includes(a)?a:xt}var vt={superadmin:"超级管理员",team:"团队管理员",editor:"业务部",viewer:"业务主管",restricted:"生产部",producer:"生产方",customer:"客户",superviewer:"总经理"};function Y(t){return t&&(t.dept||vt[t.role]||t.role)||""}function ye(t){return t==="viewer"||t==="restricted"||t==="producer"||t==="customer"}var Et=["品质部","财务部"];function _e(t){return!!t&&t.role==="restricted"&&Et.includes(t.dept||"")}function Be(t){let e=t&&t.role;return e==="editor"||e==="member"?"客户订单录入":"生产单下单权限"}function le(t){return t?T(t.role)?!0:_e(t)?!1:typeof t.canPlaceOrder=="boolean"?t.canPlaceOrder:t.role==="editor"||t.role==="member":!1}function Z(t){return T(t)||t==="superviewer"}async function X(t,e,a=!1,d=null){let m=await t.TODO_KV.list({prefix:"todos:"}),p=m.keys.map(s=>s.name.replace("todos:","")),r=await Promise.all(p.map(async s=>{let i=await t.TODO_KV.get(`user:${s}`);return i?JSON.parse(i):null})),o=[];for(let s=0;s<p.length;s++){let i=r[s];if(!i||h(i)!==e)continue;let l=await t.TODO_KV.get(m.keys[s].name),c=l?JSON.parse(l):[];for(let u of c){let f=u.status||(u.done?"done":"pending");a&&f==="pending"||d&&!d.includes(u.producerId)||o.push({...u,status:f,owner:p[s]})}}return o.sort((s,i)=>s.createdAt<i.createdAt?1:-1),o}async function kt(t,e){let a=await t.TODO_KV.list({prefix:"user:"}),d=[];for(let m of a.keys){let p=await t.TODO_KV.get(m.name);if(!p)continue;let r=null;try{r=JSON.parse(p)}catch{continue}!r||O(r.role)||h(r)===e&&d.push({username:r.username||m.name.replace(/^user:/,""),role:r.role})}return d}async function Tt(t,e){let a=0,d=await t.TODO_KV.get(`todos:${e}`);if(d)try{let m=JSON.parse(d);a=Array.isArray(m)?m.length:0}catch{a=0}return await t.TODO_KV.delete(`user:${e}`),await t.TODO_KV.delete(`todos:${e}`),await t.TODO_KV.delete(`customers:${e}`),await t.TODO_KV.delete(`watch:${e}`),await t.TODO_KV.delete(`mentions:${e}`),await t.TODO_KV.delete(`emailcode:${e}`),await t.TODO_KV.delete(`mailrate:${e}`),{todos:a}}async function St(t,e,a){let d=t.method;if(a==="/api/login"&&d==="POST"){await se(e);let{username:r,password:o}=await S(t);if(!r||!o)return n({error:"请输入用户名和密码"},400);let s=await e.TODO_KV.get(`user:${r}`);if(!s)return n({error:"用户名或密码错误"},401);let i=JSON.parse(s);if(await M(o)!==i.password)return n({error:"用户名或密码错误"},401);if(!O(i.role)){let c=await U(e,h(i));if(c&&re(c)==="disabled")return n({error:"该账户已被停用，请联系超级管理员开通"},403)}if(i.role==="team"&&i.emailVerified===!1){let c=await ct(e,i,t);return n({ok:!1,needVerify:!0,username:i.username,email:W(i.email||""),codeTtlSec:z,resendAfterSec:de,devCode:c.devCode||void 0,sendError:c.ok?void 0:c.error,message:c.ok?`确认码${c.resent?"已重新发送":"已发送"}至注册邮箱，请在 ${Math.floor(z/60)} 分钟内输入完成确认`:"确认码发送失败，请稍后点「重新发送确认码」重试"})}return be(e,i)}if(a==="/api/register"&&d==="POST"){if(await se(e),!(await j(e)).allowRegister)return n({error:"系统当前已关闭新用户注册，如需开通请联系超级管理员"},403);let{teamName:o,username:s,email:i,password:l,confirmPassword:c,contact:u,remark:f}=await S(t),g=(s||"").trim(),b=(o||"").trim(),v=String(i||"").trim(),k=String(l||"");if(!b)return n({error:"请输入团队名称"},400);if(!g)return n({error:"请输入登录用户名"},400);if(!/^[A-Za-z0-9_.-]{3,20}$/.test(g))return n({error:"用户名为 3~20 位字母、数字、下划线、点或短横线"},400);if(g==="admin")return n({error:"该用户名不可用，请更换"},400);if(!v)return n({error:"请输入邮箱"},400);if(v.length>60)return n({error:"邮箱长度不能超过 60 个字符"},400);if(!R.test(v))return n({error:"邮箱格式不正确，请检查后重试"},400);if(!k)return n({error:"请输入密码"},400);if(k.length<6)return n({error:"密码至少 6 位"},400);if(c!==void 0&&k!==String(c))return n({error:"两次输入的密码不一致"},400);if(await e.TODO_KV.get(`user:${g}`))return n({error:"该用户名已被占用，请更换"},400);let E=new Date,C={username:g,password:await M(k),role:"team",teamId:g,teamName:b,contact:String(u||"").trim(),email:v,remark:String(f||"").trim(),emailVerified:!1,plan:"trial",status:"active",trialEndsAt:"",expiresAt:"",createdAt:E.toISOString()};await e.TODO_KV.put(`user:${g}`,JSON.stringify(C));let y=await xe(e,C,t);return y.ok?n({ok:!0,needVerify:!0,username:g,role:"team",teamName:b,email:W(v),codeTtlSec:z,resendAfterSec:de,devCode:y.devCode||void 0,unlimitedTrial:!0,message:`确认码已发送至 ${W(v)}，请在 ${Math.floor(z/60)} 分钟内输入完成邮箱确认`}):(await e.TODO_KV.delete(`user:${g}`),n({error:"注册未完成："+y.error},503))}if(a==="/api/register/verify"&&d==="POST"){await se(e);let{username:r,code:o}=await S(t),s=String(r||"").trim();if(!s)return n({error:"请输入用户名"},400);let i=await e.TODO_KV.get(`user:${s}`);if(!i)return n({error:"用户名不存在，请先注册"},404);let l=JSON.parse(i);if(l.role!=="team")return n({error:"该账号无需邮箱确认"},400);if(l.emailVerified!==!1)return be(e,l);let c=await lt(e,l,o);return c.ok?(l.emailVerified=!0,l.emailVerifiedAt=new Date().toISOString(),await e.TODO_KV.put(`user:${s}`,JSON.stringify(l)),await e.TODO_KV.delete(`emailcode:${s}`),be(e,l)):n({error:c.error},400)}if(a==="/api/register/resend"&&d==="POST"){await se(e);let{username:r,password:o}=await S(t),s=String(r||"").trim();if(!s)return n({error:"请输入用户名"},400);let i=await e.TODO_KV.get(`user:${s}`);if(!i)return n({error:"用户名不存在，请先注册"},404);let l=JSON.parse(i);if(l.role!=="team")return n({error:"该账号无需邮箱确认"},400);if(l.emailVerified!==!1)return n({error:"该账号已完成邮箱确认，可直接登录"},400);if(!o||await M(String(o))!==l.password)return n({error:"密码不正确，无法重新发送确认码"},401);let c=await xe(e,l,t);return c.ok?n({ok:!0,email:W(l.email||""),codeTtlSec:z,resendAfterSec:de,devCode:c.devCode||void 0,message:`确认码已重新发送至 ${W(l.email||"")}`}):n({error:c.error},429)}if(a==="/api/logout"&&d==="POST"){let r=Me(t);return r&&await e.TODO_KV.delete(`session:${r}`),new Response(JSON.stringify({ok:!0}),{status:200,headers:{"Content-Type":"application/json; charset=utf-8","Set-Cookie":"token=; Path=/; HttpOnly; SameSite=Lax; Max-Age=0"}})}if(a==="/api/me"&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o={username:r.username,role:r.role};if(o.canPlaceOrder=le(r),T(r.role)){o.teamId=r.teamId||r.username,o.teamName=r.teamName||r.username,o.contact=r.contact||"",o.plan=ne(r)?"pro":"trial",o.pro=P(r),o.trialEndsAt=r.trialEndsAt||"",o.expiresAt=r.expiresAt||"",o.status=re(r);let i=Ae(r);o.subscribeRequest=i,o.renewRequest=i}else{let i=await U(e,h(r));o.teamId=h(r),o.teamName=i?i.teamName||i.username:"",o.teamPro=P(i)}let s=await Re(e,r.username);return o.mentionsUnread=s.unread,o.mentionsTotal=s.total,n(o)}if(a==="/api/change-password"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let{oldPassword:o,newPassword:s}=await S(t);return!o||!s?n({error:"请填写完整"},400):await M(o)!==r.password?n({error:"原密码错误"},400):(r.password=await M(s),await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r)),n({ok:!0}))}if(a==="/api/settings"&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=await j(e),s=T(r.role)?r:await U(e,h(r));return n({settings:{siteName:o.siteName,allowRegister:o.allowRegister,supportEmail:o.supportEmail,favicon:o.favicon,teamName:s?s.teamName||s.username:""}})}if(a==="/api/settings"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let{siteName:o,teamName:s,allowRegister:i,supportEmail:l,favicon:c}=await S(t);if(s!==void 0){if(!T(r.role))return n({error:"无权限"},403);let b=String(s).trim();return b?(r.teamName=b,await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r)),n({ok:!0,settings:{teamName:b}})):n({error:"请输入团队名称"},400)}if(o===void 0&&i===void 0&&l===void 0&&c===void 0)return n({error:"请填写要保存的内容"},400);if(!O(r.role))return n({error:"无权限"},403);let u=await e.TODO_KV.get("settings"),f=u?JSON.parse(u):{};if(o!==void 0){if(!o||!o.trim())return n({error:"请输入网站名称"},400);f.siteName=o.trim()}if(i!==void 0&&(f.allowRegister=i===!0||i==="true"),l!==void 0){let b=String(l||"").trim();if(b.length>60)return n({error:"联系邮箱长度不能超过 60 个字符"},400);if(b&&!R.test(b))return n({error:"联系邮箱格式不正确，请检查后重试（留空则不显示该提示）"},400);f.supportEmail=b}if(c!==void 0){let b=String(c||"").trim();if(b.length>300)return n({error:"网站图标链接不能超过 300 个字符"},400);let v=K(b);if(v===null)return n({error:"网站图标需填写以 http:// 或 https:// 开头的图片链接（留空则使用默认图标）"},400);f.favicon=v}await e.TODO_KV.put("settings",JSON.stringify(f));let g=await j(e);return n({ok:!0,settings:{siteName:g.siteName,allowRegister:g.allowRegister,supportEmail:g.supportEmail,favicon:g.favicon}})}if((a==="/api/subscribe-request"||a==="/api/renew-request")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);let{note:o,contact:s,plan:i}=await S(t);s!==void 0&&(r.contact=String(s||"").trim().slice(0,50));let l=i&&typeof i=="object"?i:null,c=l&&Number(l.days)>0?Math.floor(Number(l.days)):0,u={at:new Date().toISOString(),kind:P(r)?"renew":"subscribe",plan:l&&c?{id:String(l.id||"").slice(0,20),term:String(l.term||"").slice(0,20),price:Number(l.price)>=0?Number(l.price):0,days:c}:null,note:String(o||"").trim().slice(0,200),contact:r.contact||""};r.subscribeRequest=u,delete r.renewRequest,await e.TODO_KV.put(`user:${r.username}`,JSON.stringify(r));let f={ok:!1,to:r.email||"",cc:[],error:""};try{if(!r.email)f.error="该账号没有可用邮箱，无法发送申请邮件";else{let g=await ee(e),b=await j(e),v=et(g,b);if(f.cc=F({to:r.email,cc:v?[v]:[]}),g.devMode)f.ok=!0,f.devMode=!0;else{let k=await dt(e,r,u,g,u.kind),x=await we(e,g,{to:r.email,cc:f.cc,subject:k.subject,text:k.text,html:k.html},{local:ue(t)});f.ok=!!x.ok,x.ok||(f.error=x.error||"邮件发送失败")}}}catch(g){f.ok=!1,f.error="邮件发送异常："+(g&&g.message?g.message:String(g))}return console.log(`[订阅申请邮件] ${r.username} -> ${f.to||"-"}`+(f.cc&&f.cc.length?`（抄送 ${f.cc.join(", ")}）`:"")+` ${f.ok?"成功":"失败："+f.error}`),n({ok:!0,subscribeRequest:u,mail:f})}let m="/api/teams";if(a===m&&d==="GET"){let r=await w(t,e);return r?O(r.role)?n({teams:await ut(e)}):n({error:"无权限"},403):n({error:"未登录"},401)}if(a.startsWith(`${m}/`)&&a.endsWith("/status")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/status","")),{status:s}=await S(t);if(!["active","disabled"].includes(s))return n({error:"无效的状态"},400);let i=await U(e,o);return i?(i.status=s,await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,status:re(i),expiresAt:i.expiresAt||i.trialEndsAt||""})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&a.endsWith("/renew")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/renew","")),s=await S(t),i=Number(s.days)>0?Math.floor(Number(s.days)):30;if(i>3650)return n({error:"续费天数过大"},400);let l=await U(e,o);if(!l)return n({error:"团队用户不存在"},404);let c=Date.now(),u=new Date(l.expiresAt||"").getTime(),f=Number.isNaN(u)||u<c?c:u,g=new Date(f+i*je).toISOString();return l.expiresAt=g,l.status="active",l.plan="pro",l.renewedAt=new Date().toISOString(),delete l.subscribeRequest,delete l.renewRequest,await e.TODO_KV.put(`user:${o}`,JSON.stringify(l)),n({ok:!0,days:i,expiresAt:g,status:"active",pro:!0})}if(a.startsWith(`${m}/`)&&a.endsWith("/reset-password")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/reset-password","")),{newPassword:s}=await S(t);if(!s||!String(s).trim())return n({error:"请输入新密码"},400);let i=await U(e,o);return i?(i.password=await M(String(s).trim()),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&a.endsWith("/remark")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.replace(`${m}/`,"").replace("/remark","")),{remark:s}=await S(t),i=await U(e,o);return i?(i.remark=String(s||"").trim(),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,remark:i.remark})):n({error:"团队用户不存在"},404)}if(a.startsWith(`${m}/`)&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let o=decodeURIComponent(a.slice(m.length+1));if(!o||o.indexOf("/")!==-1)return n({error:"接口不存在"},404);let s=await U(e,o);if(!s)return n({error:"团队用户不存在"},404);if(s.status!=="disabled")return n({error:"请先「停用」该团队用户，确认无误后再删除"},400);let i=await kt(e,o),l=i.reduce((g,b)=>(g[b.role]=(g[b.role]||0)+1,g),{}),c=0;for(let g of i){let b=await Tt(e,g.username);c+=b.todos}let u=await L(e,o),f=await V(e,o);return await e.TODO_KV.delete(`producers:${o}`),await e.TODO_KV.delete(`customerList:${o}`),n({ok:!0,deleted:{team:o,teamName:s.teamName||o,accounts:i.length,members:i.filter(g=>!["team","producer","customer"].includes(g.role)).length,producers:u.length,customers:f.length,todos:c,roles:l}})}if(a==="/api/admin/email-settings"&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let o=await ee(e);return n({settings:Pe(o,e)})}if(a==="/api/admin/email-settings"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let{from:o,fromName:s,apiKey:i,devMode:l,smtpHost:c,smtpPort:u,smtpUser:f,smtpPass:g,adminNotifyEmail:b,subExtraText:v,subQrCodes:k}=await S(t),x=await e.TODO_KV.get("emailSettings"),E=x?JSON.parse(x):{};if(o!==void 0){let y=String(o||"").trim();if(y&&!R.test(y))return n({error:"发件邮箱格式不正确，请检查后重试"},400);E.from=y}if(s!==void 0&&(E.fromName=String(s||"").trim().slice(0,30)),i!==void 0){let y=String(i||"").trim();y==="-"?delete E.apiKey:y&&(E.apiKey=y)}if(c!==void 0){let y=String(c||"").trim();if(y&&!/^[A-Za-z0-9.-]{1,60}$/.test(y))return n({error:"SMTP 服务器地址格式不正确（例如 smtp.qq.com）"},400);E.smtpHost=y||"smtp.qq.com"}if(u!==void 0){let y=String(u??"").trim(),I=Number(y)||0;if(y&&(I<1||I>65535))return n({error:"SMTP 端口需为 1~65535 的数字（QQ 邮箱用 465，或 587 + STARTTLS）"},400);E.smtpPort=I||465}if(f!==void 0){let y=String(f||"").trim();if(y&&!R.test(y))return n({error:"SMTP 账号需填写完整邮箱地址（例如 xxx@qq.com）"},400);E.smtpUser=y}if(g!==void 0){let y=String(g||"").trim();y==="-"?delete E.smtpPass:y&&(E.smtpPass=y)}if(l!==void 0&&(E.devMode=!!l),b!==void 0){let y=String(b||"").trim();if(y&&!R.test(y))return n({error:"管理员提醒邮箱格式不正确（留空则默认抄送到发件邮箱）"},400);E.adminNotifyEmail=y}if(v!==void 0){let y=String(v||"").replace(/\r\n/g,`
`).trim();if(y.length>1e3)return n({error:"自定义说明不能超过 1000 个字符"},400);E.subExtraText=y}if(k!==void 0){let y=Array.isArray(k)?k.slice(0,H):[];if(y.length&&k.length>H)return n({error:`收款二维码最多 ${H} 个`},400);for(let $=0;$<y.length;$++){let B=String(y[$]||"").trim();if(B){if(B.length>300)return n({error:`收款二维码链接太长（第 ${$+1} 个，最多 300 个字符）`},400);if(K(B)===null)return n({error:`收款二维码需填写以 http:// 或 https:// 开头的图片链接（第 ${$+1} 个，留空则不显示）`},400)}}let I=pe(y);for(;I.length&&!I[I.length-1];)I.pop();E.subQrCodes=I}await e.TODO_KV.put("emailSettings",JSON.stringify(E));let C=await ee(e);return n({ok:!0,settings:Pe(C,e)})}if(a==="/api/admin/email-test"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!O(r.role))return n({error:"无权限"},403);let{to:o}=await S(t),s=String(o||"").trim();if(!s)return n({error:"请输入测试收件邮箱"},400);if(!R.test(s))return n({error:"测试收件邮箱格式不正确"},400);let i=await ee(e);if(i.devMode)return n({ok:!0,devMode:!0,message:"当前为调试模式（不真实发送邮件），无需测试发信"});if(!i.provider)return n({error:"邮件服务未配置：请填写 QQ 邮箱 SMTP 账号与授权码（或 Resend API Key）并保存后，再发送测试邮件"},400);let l=i.provider==="smtp"?"QQ 邮箱 SMTP":i.provider==="resend"?"Resend":"Cloudflare 邮件绑定",c=await we(e,i,{to:s,subject:"【测试】邮件服务配置正常",text:"这是一封测试邮件：收到本邮件说明「注册邮箱确认码」的发件服务已配置成功。",html:"<p>这是一封测试邮件：收到本邮件说明「注册邮箱确认码」的发件服务已配置成功。</p>"},{local:ue(t)});return c.ok?n({ok:!0,message:`测试邮件已通过 ${l} 发送至 ${s}，请查收（若没收到，请检查垃圾邮件箱）`}):n({error:c.error},400)}if(a==="/api/users"&&d==="GET"){let r=await w(t,e);return r?T(r.role)?P(r)?n({users:await Le(e,h(r))}):N():n({error:"无权限"},403):n({error:"未登录"},401)}if(a==="/api/users"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let{username:o,password:s,role:i,dept:l}=await S(t);if(!o||!s)return n({error:"请填写用户名和密码"},400);let c=["restricted","superviewer"].includes(i)?i:"editor";if(await e.TODO_KV.get(`user:${o}`))return n({error:"用户名已存在"},400);let f={username:o,password:await M(s),role:c,teamId:h(r),createdAt:new Date().toISOString()},g=ht(l,c);return g&&(f.dept=g),await e.TODO_KV.put(`user:${o}`,JSON.stringify(f)),n({ok:!0})}if(a.startsWith("/api/users/")&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=decodeURIComponent(a.replace("/api/users/",""));return await A(e,o,h(r))?(await e.TODO_KV.delete(`user:${o}`),await e.TODO_KV.delete(`todos:${o}`),await e.TODO_KV.delete(`customers:${o}`),await e.TODO_KV.delete(`watch:${o}`),await e.TODO_KV.delete(`mentions:${o}`),n({ok:!0})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/reset-password")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace("/api/users/","").replace("/reset-password","")),{newPassword:i}=await S(t);if(!i||!i.trim())return n({error:"请输入新密码"},400);let l=await e.TODO_KV.get(`user:${s}`);if(!l){let f=(await L(e,o)).find(v=>v.username===s);if(f)return await e.TODO_KV.put(`user:${s}`,JSON.stringify({username:s,password:await M(i),role:"producer",producerId:f.id,teamId:o,createdAt:new Date().toISOString()})),n({ok:!0,created:!0});let b=(await V(e,o)).find(v=>v.name===s);return b?(await e.TODO_KV.put(`user:${s}`,JSON.stringify({username:s,password:await M(i),role:"customer",customerId:b.id,customerName:b.name,teamId:o,createdAt:new Date().toISOString()})),n({ok:!0,created:!0})):n({error:"成员不存在"},404)}let c=JSON.parse(l);return O(c.role)||h(c)!==o?n({error:"成员不存在"},404):(c.password=await M(i),await e.TODO_KV.put(`user:${s}`,JSON.stringify(c)),n({ok:!0}))}if(a.startsWith("/api/users/")&&a.endsWith("/remark")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=decodeURIComponent(a.replace("/api/users/","").replace("/remark","")),{remark:s}=await S(t),i=await A(e,o,h(r));return i?(i.remark=String(s||"").trim(),await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,remark:i.remark})):n({error:"成员不存在"},404)}if(a.startsWith("/api/users/")&&a.endsWith("/order-permission")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=decodeURIComponent(a.replace("/api/users/","").replace("/order-permission","")),{canPlaceOrder:s}=await S(t);if(typeof s!="boolean")return n({error:"请传入 true（有）或 false（无）"},400);let i=await A(e,o,h(r));return i?_e(i)?n({error:Y(i)+"成员不需要「生产单下单权限」（该部门无录入/下单需求），无需设置"},400):(i.canPlaceOrder=s,await e.TODO_KV.put(`user:${o}`,JSON.stringify(i)),n({ok:!0,canPlaceOrder:s})):n({error:"成员不存在"},404)}if(a.startsWith("/api/customers/")&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=decodeURIComponent(a.replace("/api/customers/",""));return o!==r.username&&!(T(r.role)?await A(e,o,h(r)):null)?n({error:"无权限"},403):n({customers:await Q(e,o)})}if(a.startsWith("/api/customers/")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=decodeURIComponent(a.replace("/api/customers/",""));if(!await A(e,o,h(r)))return n({error:"成员不存在"},404);let{name:i,globalId:l}=await S(t);if(!i||!i.trim())return n({error:"请输入客户名称"},400);let c=await Q(e,o),u=i.trim(),f=l?String(l).trim():"";if(c.some(b=>b.name===u||f&&b.id===f))return n({error:"客户已存在"},400);let g={id:f||D().slice(0,12),name:u,createdAt:new Date().toISOString()};return c.push(g),await he(e,o,c),n({ok:!0,customer:g})}if(a.startsWith("/api/customers/")&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=decodeURIComponent(a.replace("/api/customers/","")),s=o.lastIndexOf("/");if(s===-1)return n({error:"参数错误"},400);let i=o.slice(0,s),l=o.slice(s+1);if(!await A(e,i,h(r)))return n({error:"成员不存在"},404);let u=await Q(e,i);return u=u.filter(f=>f.id!==l),await he(e,i,u),n({ok:!0})}if(a==="/api/customer-list"&&d==="GET"){let r=await w(t,e);return r?!T(r.role)||!P(r)?N():n({customers:await V(e,h(r))}):n({error:"未登录"},401)}if(a==="/api/customer-list"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);let o=h(r),{name:s,password:i,description:l}=await S(t);if(!s||!s.trim())return n({error:"请输入用户名"},400);if(!i||!String(i).trim())return n({error:"请输入密码"},400);let c=await V(e,o),u=s.trim();if(c.some(b=>b.name===u))return n({error:"该用户名已存在"},400);if(await e.TODO_KV.get(`user:${u}`))return n({error:"该用户名已被占用"},400);let g={id:D().slice(0,12),name:u,description:(l||"").trim(),createdAt:new Date().toISOString()};return c.push(g),await ce(e,o,c),await e.TODO_KV.put(`user:${u}`,JSON.stringify({username:u,password:await M(String(i).trim()),role:"customer",customerId:g.id,customerName:u,teamId:o,createdAt:g.createdAt})),n({ok:!0,customer:g})}if(a.startsWith("/api/customer-list/")&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace("/api/customer-list/","")),i=await V(e,o),l=i.find(c=>c.id===s);return i=i.filter(c=>c.id!==s),await ce(e,o,i),l&&l.name&&await e.TODO_KV.delete(`user:${l.name}`),n({ok:!0})}if(a.startsWith("/api/customer-list/")&&a.endsWith("/description")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace("/api/customer-list/","").replace("/description","")),{description:i}=await S(t),l=await V(e,o),c=l.find(u=>u.id===s);return c?(c.description=String(i||"").trim(),await ce(e,o,l),n({ok:!0,description:c.description})):n({error:"客户不存在"},404)}if(a==="/api/producers"&&d==="GET"){let r=await w(t,e);return r?n({producers:await L(e,h(r))}):n({error:"未登录"},401)}if(a==="/api/producers"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),{username:s,password:i,description:l,nature:c}=await S(t),u=(s||"").trim();if(!u)return n({error:"请输入用户名"},400);if(!i||!String(i).trim())return n({error:"请输入密码"},400);let f=await L(e,o);if(f.some(v=>v.username===u))return n({error:"该用户名已存在"},400);if(await e.TODO_KV.get(`user:${u}`))return n({error:"该用户名已被成员占用"},400);let b={id:D().slice(0,12),username:u,description:(l||"").trim(),nature:De(c),createdAt:new Date().toISOString()};return f.push(b),await ie(e,o,f),await e.TODO_KV.put(`user:${u}`,JSON.stringify({username:u,password:await M(String(i).trim()),role:"producer",producerId:b.id,teamId:o,createdAt:b.createdAt})),n({ok:!0,producer:b})}if(a.startsWith("/api/producers/")&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace("/api/producers/","")),i=await L(e,o),l=i.find(c=>c.id===s);return i=i.filter(c=>c.id!==s),await ie(e,o,i),l&&l.username&&await e.TODO_KV.delete(`user:${l.username}`),n({ok:!0})}if(a.startsWith("/api/producers/")&&a.endsWith("/description")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace("/api/producers/","").replace("/description","")),{description:i}=await S(t),l=await L(e,o),c=l.find(u=>u.id===s);return c?(c.description=String(i||"").trim(),await ie(e,o,l),n({ok:!0,description:c.description})):n({error:"生产方不存在"},404)}if(a.startsWith("/api/producers/")&&a.endsWith("/nature")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace("/api/producers/","").replace("/nature","")),{nature:i}=await S(t),l=String(i??"").trim();if(!Ue.includes(l))return n({error:"生产方性质只能是「自产」或「外购」"},400);let c=await L(e,o),u=c.find(f=>f.id===s);return u?(u.nature=l,await ie(e,o,c),n({ok:!0,nature:u.nature})):n({error:"生产方不存在"},404)}let p="/api/watch/";if(a.startsWith(p)&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=h(r),s=decodeURIComponent(a.replace(p,""));if(s!==r.username&&!(T(r.role)?await A(e,s,o):null))return n({error:"无权限"},403);let i=await te(e,s),l=await L(e,o),c=i.map(u=>{let f=l.find(g=>g.id===u);return f||{id:u,username:"（已删除的生产方）",description:"",deleted:!0}});return n({producers:c})}if(a.startsWith(p)&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=h(r),s=decodeURIComponent(a.replace(p,"")),i=await A(e,s,o);if(!i)return n({error:"成员不存在"},404);let{producerId:l}=await S(t);if(!l||!String(l).trim())return n({error:"请选择生产方"},400);let c=String(l).trim();if(!(await L(e,o)).some(g=>g.id===c))return n({error:"生产方不存在，请先在「生产方管理」中添加"},400);if(i.role!=="restricted")return n({error:"该成员不是「生产部」成员，无法授权可观察的生产方"},400);let f=await te(e,s);return f.includes(c)?n({error:"已授权该生产方"},400):(f.push(c),await Oe(e,s,f),n({ok:!0,producerIds:f}))}if(a.startsWith(p)&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!T(r.role))return n({error:"无权限"},403);if(!P(r))return N();let o=decodeURIComponent(a.replace(p,"")),s=o.lastIndexOf("/");if(s===-1)return n({error:"参数错误"},400);let i=o.slice(0,s),l=o.slice(s+1);if(!await A(e,i,h(r)))return n({error:"成员不存在"},404);let u=await te(e,i);return u=u.filter(f=>f!==l),await Oe(e,i,u),n({ok:!0,producerIds:u})}if(a==="/api/team-members"&&d==="GET"){let r=await w(t,e);return r?n({members:await Ne(e,h(r))}):n({error:"未登录"},401)}if(a==="/api/mentions"&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=await me(e,r.username);return n({items:o,unread:o.filter(s=>!s.read).length,total:o.length})}if(a==="/api/mentions/read"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=await S(t),s=o&&o.id?String(o.id).trim():"",i=!(o&&o.read===!1),l=await me(e,r.username),c=0;for(let u of l)u.read!==i&&(s&&u.id!==s||(u.read=i,c++));return c&&await $e(e,r.username,l),n({ok:!0,changed:c,read:i,unread:l.filter(u=>!u.read).length,total:l.length})}if(a==="/api/todos"&&d==="GET"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=h(r);if(Z(r.role))return n({todos:await X(e,o,!1),readonly:!1,allUsers:!0});if(r.role==="viewer")return n({todos:await X(e,o,!0),readonly:!0,allUsers:!0});if(r.role==="restricted"){let s=await te(e,r.username);return n({todos:await X(e,o,!0,s),readonly:!0,allUsers:!0})}if(r.role==="producer"){let i=(await L(e,o)).find(l=>l.id===r.producerId);return n({todos:await X(e,o,!0,i?[i.id]:[]),readonly:!0,allUsers:!0})}if(r.role==="customer"){let s=r.customerName||"",i=s?await X(e,o,!0):[];return n({todos:i.filter(l=>l.customer===s),readonly:!0,allUsers:!0})}return n({todos:await q(e,r.username),readonly:!1})}if(a==="/api/todos"&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!le(r))return n({error:Y(r)+"无「"+Be(r)+"」，请联系团队管理员在「成员管理」中开通"},403);let{title:o,customer:s,dueDate:i,amount:l,orderUrl:c,purchaseUrl:u,currency:f}=await S(t);if(!s||!s.trim())return n({error:"选择客户"},400);if(!o||!o.trim())return n({error:"请输入主题"},400);if(!i||!String(i).trim())return n({error:"选择交期"},400);let g=K(c);if(g===null)return n({error:"订单文件链接需以 http:// 或 https:// 开头"},400);let b=K(u);if(b===null)return n({error:"采购文件链接需以 http:// 或 https:// 开头"},400);if(l==null||String(l).trim()==="")return n({error:"输入金额"},400);let v=Number(l);if(Number.isNaN(v)||v<0)return n({error:"金额必须为非负数字"},400);let k=s.trim();if(T(r.role)&&!P(r))await mt(e,r,k);else if(T(r.role)){let C=await V(e,h(r)),y=await Q(e,r.username);if(!C.some(I=>I.name===k)&&!y.some(I=>I.name===k))return n({error:"客户不存在，请先在「客户管理」中添加"},400)}else if(!(await Q(e,r.username)).some(y=>y.name===k))return n({error:"客户不存在，请联系管理员添加"},400);let x=await q(e,r.username),E={id:D().slice(0,12),customer:s.trim(),title:o.trim(),dueDate:String(i).trim(),amount:v,currency:Ge(f),orderUrl:g,purchaseUrl:b,notes:[],status:"pending",done:!1,createdAt:new Date().toISOString()};return x.unshift(E),await G(e,r.username,x),n({ok:!0,todo:E})}if(a.startsWith("/api/todos/")&&a.endsWith("/notes")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);let o=decodeURIComponent(a.replace("/api/todos/","").replace("/notes","")),s=await S(t),i=s.text;if(!i||!i.trim())return n({error:"请输入备注内容"},400);let l=r.username;if(ye(r.role)||Z(r.role)){let x=s.owner||r.username;if(x!==r.username&&!await A(e,x,h(r)))return n({error:"无权操作该用户的待办"},403);l=x}let c=await q(e,l),u=c.findIndex(x=>x.id===o);if(u===-1)return n({error:"未找到"},404);Array.isArray(c[u].notes)||(c[u].notes=[]);let f=await Ne(e,h(r)),g=new Set(f.map(x=>x.username)),b=new Set;if(Array.isArray(s.mentions))for(let x of s.mentions){let E=String(x||"").trim();E&&g.has(E)&&b.add(E)}for(let x of gt(i))g.has(x)&&b.add(x);b.delete(r.username);let v=[...b],k={id:D().slice(0,12),text:i.trim(),author:r.username,createdAt:new Date().toISOString(),mentions:v};return c[u].notes.push(k),await G(e,l,c),await yt(e,r,v,{todoId:c[u].id,todoTitle:c[u].title,owner:l,text:k.text}),n({ok:!0,note:k})}if(a.startsWith("/api/todos/")&&d==="PUT"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(ye(r.role))return n({error:Y(r)+"无编辑权限"},403);let o=decodeURIComponent(a.replace("/api/todos/","")),s=await S(t);if((typeof s.status=="string"||typeof s.done=="boolean")&&!Z(r.role))return n({error:"只有团队管理员或总经理可以改变待办状态"},403);let l=r.username;if(Z(r.role)&&s.owner&&s.owner!==r.username){if(!await A(e,s.owner,h(r)))return n({error:"无权操作该用户的待办"},403);l=s.owner}let c=await q(e,l),u=c.findIndex(f=>f.id===o);if(u===-1)return n({error:"未找到"},404);if(typeof s.title=="string"){let f=s.title.trim();if(!f)return n({error:"请输入 PO# / 主题"},400);c[u].title=f}if(typeof s.dueDate=="string"||s.amount!==void 0||s.orderUrl!==void 0||s.purchaseUrl!==void 0){if((c[u].status||(c[u].done?"done":"pending"))!=="pending")return n({error:"仅「待确认」的待办可修改交期/金额/文件链接"},403);if(typeof s.dueDate=="string"){let g=s.dueDate.trim();if(!/^\d{4}-\d{2}-\d{2}$/.test(g))return n({error:"请输入正确的交期"},400);c[u].dueDate=g}if(s.amount!==void 0&&s.amount!==null&&String(s.amount).trim()!==""){let g=Number(s.amount);if(Number.isNaN(g)||g<0)return n({error:"金额必须为非负数字"},400);c[u].amount=g}if(s.orderUrl!==void 0){let g=K(s.orderUrl);if(g===null)return n({error:"订单文件链接需以 http:// 或 https:// 开头"},400);c[u].orderUrl=g}if(s.purchaseUrl!==void 0){let g=K(s.purchaseUrl);if(g===null)return n({error:"采购文件链接需以 http:// 或 https:// 开头"},400);c[u].purchaseUrl=g}}if(typeof s.producerId=="string"&&s.producerId.trim()){let g=(await L(e,h(r))).find(b=>b.id===s.producerId.trim());if(!g)return n({error:"生产方不存在，请先在「生产方管理」中添加"},400);c[u].producerId=g.id,c[u].producerName=g.username,c[u].producerAssignedAt=new Date().toISOString()}if(typeof s.status=="string"){if(!["pending","doing","done"].includes(s.status))return n({error:"无效的状态"},400);c[u].status=s.status,c[u].done=s.status==="done"}else typeof s.done=="boolean"&&(c[u].done=s.done,c[u].status=s.done?"done":"doing");return c[u].status==="doing"&&!c[u].producerId&&await Ye(e,r)?n({error:"请为该待办指定生产方（生产方来自「生产方管理」）"},400):(await G(e,l,c),n({ok:!0,todo:c[u]}))}if(a.startsWith("/api/todos/")&&a.endsWith("/purchase-link")&&d==="POST"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(!le(r))return n({error:Y(r)+"无「"+Be(r)+"」，请联系团队管理员在「成员管理」中开通"},403);let o=decodeURIComponent(a.replace("/api/todos/","").replace("/purchase-link","")),s=await S(t),i=r.username;if(s.owner&&s.owner!==r.username){if(!await A(e,s.owner,h(r)))return n({error:"无权操作该用户的待办"},403);i=s.owner}let l=await q(e,i),c=l.findIndex(f=>f.id===o);if(c===-1)return n({error:"未找到"},404);if(l[c].purchaseUrl)return n({error:"该订单已有采购文件链接，如需修改请联系团队管理员"},403);let u=K(s.purchaseUrl);return u===null?n({error:"采购文件链接需以 http:// 或 https:// 开头"},400):u?(l[c].purchaseUrl=u,await G(e,i,l),n({ok:!0,purchaseUrl:u})):n({error:"请输入采购文件链接"},400)}if(a.startsWith("/api/todos/")&&d==="DELETE"){let r=await w(t,e);if(!r)return n({error:"未登录"},401);if(ye(r.role))return n({error:Y(r)+"无删除权限"},403);let o=decodeURIComponent(a.replace("/api/todos/","")),s=r.username;if(Z(r.role)){let u=new URL(t.url).searchParams.get("owner");if(u&&u!==r.username){if(!await A(e,u,h(r)))return n({error:"无权操作该用户的待办"},403);s=u}}let i=await q(e,s),l=i.find(u=>u.id===o);return l?(l.status||(l.done?"done":"pending"))!=="pending"?n({error:"该事件已进入「进行中/已完成」状态，无法删除"},403):(i=i.filter(u=>u.id!==o),await G(e,s,i),n({ok:!0})):n({error:"未找到"},404)}return n({error:"接口不存在"},404)}var Ot={async fetch(t,e,a){let d=new URL(t.url),m=d.pathname;if(m.startsWith("/api/"))try{return await St(t,e,m)}catch(p){return n({error:"服务器错误: "+p.message},500)}if(m==="/"||m==="/login"){let p=await j(e);return new Response(ve(p.siteName,p.allowRegister,p.supportEmail,p.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}if(m==="/todos"){let p=await j(e);return new Response(Ee(p.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}if(m==="/admin"){let p=await w(t,e);if(!p)return Response.redirect(d.origin+"/",302);if(!O(p.role))return Response.redirect(d.origin+"/todos",302);let r=await j(e);return new Response(ke(r.favicon),{headers:{"Content-Type":"text/html; charset=utf-8"}})}return new Response("Not Found",{status:404})}};export{Ot as default};
